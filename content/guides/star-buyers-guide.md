...
description = "While planets are the best way to use Urbit long-term for most, stars are the best way to take an ownership stake in the network itself."
tabbed = "true"
+++
...
<div class="nomarkdown flex items-center">
...
<div class="flex flex-col" style="margin-left: 1rem;">
...
<div class="nomarkdown flex items-center" style="margin-top: 1rem;">
...
A star is the second layer of the Urbit network hierarchy, below galaxies.  Each galaxy can spawn 255 stars, which means there will only be 65,280 stars.  Each star may spawn 65,535 planets, which means there can be over 4 billion planets.

Galaxies sponsor stars, which means stars receive software updates from galaxies and can pass them on to ships.  Stars may switch galaxy sponsors just as planets may shift star sponsors.
...
Stars deliver over-the-air network updates to their planets from galaxies.

Soon, galaxies will delegate the responsibility of peer discovery to stars – which means stars will have significant policy-making power on their corner of the network.  Namely, to disallow planets and stars from operating in their corner of the network.

What actors are allowed in your star?  What are the criteria for operating a planet under your star?  What are the criteria and procedures for losing sponsorship from your star, and for regaining it?  These fundamental governance questions will need to be addressed and coordinated with developers and community leaders who create and use moderation tools for groups and other applications.

**Services**  

As a star owner and operator, you will have the opportunity to provide services to any planets under you.  This could mean anything from custom onboarding experience and application suites to unique content filtering policies.  You’ll have the foundation for tools to roll and share your own flavor of urbit for the type of organizations and individuals that you want to support.
...
![](https:///media.urbit.org/operators/step-1.png)
...
![](https:///media.urbit.org/operators/step-3.png)
...
![](https:///media.urbit.org/operators/step-4.png)
...
![](https:///media.urbit.org/operators/step-5.png)
...
![](https:///media.urbit.org/operators/step-5-2.png)
...
![](https://media.urbit.org/operators/step-5-3.png)
...
![](https://media.urbit.org/operators/sale-step-2.png)
...
![](https://media.urbit.org/operators/sale-step-3-5.png)
